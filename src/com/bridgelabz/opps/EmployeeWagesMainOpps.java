...
public class EmployeeWagesMainOpps {
    ...
    public static void main(String[] args) {
        ...
        EmployeeWagesMainOpps EWM = new EmployeeWagesMainOpps();
        ...
        while( totalEmpHrs <= MAX_HOUR_IN_MONTH && totalWorkingDays < NUM_WORKING_DAYS) {
            ...
            EWM.getEmployeeType();
            EWM.calculateEmpWage();
        }

        //Displaying Total Emp Wages
        System.out.println("Total Employee Wages = "+ EWM.totalEmpWage);
    }
}