...
public class  LineComparisonMainOpps {
    ...
    public static void main(String[] args) {
        ...
        LineComparisonMainOpps LCM1 =new LineComparisonMainOpps();
        LineComparisonMainOpps LCM2 =new LineComparisonMainOpps();
        ...
        double line1Length = LCM1.getLengthOfLine();
        double line2Length = LCM2.getLengthOfLine();
